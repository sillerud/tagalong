...
<div class="container">
    ...
    <div class="header-image-wrap">
        ...
        <!--<div class="page-profile-image" style="background-image: url('../statisk/images/');">
        </div>-->

        <div class="page-name"><h1>Movie Night</h1></div>
                ...
                <div class="page-left-column">
                    ...
                    <div class="about-box box">
                        ...
                        <div class="about-box-text">
                              <div class="event-time-area">
                                   <i class="fa fa-clock-o fa-2x event-time-icon"></i>
                                   <p class="event-time">16.00-21.00</p>
                               </div>
                               
                               <div class="event-date-area">
                                   <i class="fa fa-calendar fa-2x event-date-icon"></i>
                                   <p class="single-event-info event-date">Tirsdag 8. mai 2016</p>
                               </div>
                               
                               <div class="event-place-area">
                                   <i class="fa fa-map-marker fa-2x event-place event-place-icon"></i>
                                   <p class="event-place">Westerdals, campus Galleriet</p>
                                   <p class="event-place">Oslo 0450</p>
                               </div>
                               
                            <p class="text-shown event-text">
                            ...
                            <p class="text-hidden more-event-text">
                    ...
                    <div class="attending-box box">
                        ...
                        <div class="attending-thumbs-wrap">
                            <div class="person-image" style="border: 2px solid #fd7265;">
                                <img class="img-responsive" src="../statisk/images/profilbilde_jap.jpg" alt="">
                            </div>
                                    
                            <div class="person-image" style="border: 2px solid #FED575;">
                                <img class="img-responsive" src="images/profilbilde_2.jpg" alt="">
                            </div>
                        </div><!-- END attending-thumbs-wrap-->
                                                
                        <div class="view-all-attending">
                            <span>See all</span>
                        </div>
                        
                    </div><!-- END attending-box -->
                   ...
                   <!-- <div class="gallery-box box">
                        ...
                        <div class="gallery-thumbs-wrap">
                            <div galery-image class="gallery-thumb">
                                <img class="thumb" src="../statisk/images/ola_nordmann.jpeg" alt="">
                            </div>
                            <div galery-image class="gallery-thumb">
                                <img class="thumb" src="../statisk/images/ola_nordmann_sidebilde.jpg" alt="">
                            </div>
                            <div galery-image class="gallery-thumb">
                                <img class="thumb" src="../statisk/images/event_pic.jpg" alt="">
                            </div>
                            <div galery-image class="gallery-thumb">
                                <img class="thumb" src="../statisk/images/ola_nordmann_sidebilde.jpg" alt="">
                            </div>
                            <div galery-image class="gallery-thumb">
                                <img class="thumb" src="../statisk/images/profilbilde_jap.jpg" alt="">
                            </div>
                            <div galery-image class="gallery-thumb">
                                <img class="thumb" src="../statisk/images/ola_nordmann_sidebilde.jpg" alt="">
                            </div>
